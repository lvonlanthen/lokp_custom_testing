...
def test_show_pending_stakeholders(testcase):
    ...
    # Go to the grid view of Stakeholders. Check that the created Stakeholder is
    # visible, also after clicking the "Show only pending" button.
    ...
    # In the Activity form when adding an Involvement, the Stakeholder should be
    # visible too
    knownSh = [{
        'name': shName
    }]
