...
FEEDBACK_HISTORY_NOT_FOUND = 'No version to display.'
...
LINK_DELETE_ACTIVITY = 'Delete this Activity'
LINK_DELETE_STAKEHOLDER = 'Delete this Stakeholder'
LINK_REVIEW = 'Review'
...
TEXT_INACTIVE_VERSION = 'Not an active Version'
...
TITLE_HISTORY_RSS = 'Version history'
